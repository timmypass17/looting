...
class StoreDealsCollectionViewCell: UICollectionViewCell {

    static let reuseIdentifier = "StoreDealsCollectionViewCell"
    ...
    func configureCell(_ deal: Deal, hideBottomLine: Bool) {
        titleLabel.text = deal.title
        subtitleLabel.text = "Desscripton"
        imageView.backgroundColor = .placeholderText
//        installButton.setTitle(app.formattedPrice, for: .normal)
        installButton.titleLabel?.text = "GET"
